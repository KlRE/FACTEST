...
# O3_rotated = pc.Polytope(A, b4_rotated)4
O3_vertices = [[1, 8], [3, 6], [-1, 6], [1, 4]]
O3_rotated = pc.qhull(np.array(O3_vertices))
...
O8_vertices = [[1, 2], [3, 0], [1, -2], [-1, 0]]
O8_rotated = pc.qhull(np.array(O8_vertices))
...
workspace = pc.Polytope(A, rotate_b_vector(np.array([4, 10, 5, 7])))
