...
title = '2D Curve Environment (Rotated 90 Degrees) Unsolvable'
A = np.array([[-1, 0],
              [1, 0],
              [0, -1],
              [0, 1]])
...
# Add boundaries
b11 = np.array([5, -4, -3, 8])
O11 = pc.Polytope(A, b11)
b12 = np.array([-6, 7, -3, 8])
...
O = [O1_rotated, O2_rotated, O3_rotated, O4_rotated, O5_rotated,
     O6_rotated, O7_rotated, O8_rotated, O9_rotated, O10_rotated, O11, O12]
