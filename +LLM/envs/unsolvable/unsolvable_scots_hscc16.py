...
b16 = np.array([-9.9, 10, 0, 10])
b17 = np.array([0, 0.1, 0, 10])
b18 = np.array([0, 10, 0, 0.1])
b19 = np.array([0, 10, -9.9, 10])
...
O = [O1, O2, O3, O4, O5, O6, O7, O8, O9, O10, O11, O12, O13, O14, O15, O16, O17, O18, O19]
