...
#horizontal
b1 = np.array([-2,4,-0.9,1])
b2 = np.array([-8,9,-0.9,1])
b3 = np.array([-3,4,-1.9,2])
b4 = np.array([-7,9,-1.9,2])
b5 = np.array([-6,8,-2.9,3])
b6 = np.array([-1,3,-3.9,4])
b7 = np.array([-1,4,-4.9,5])
b8 = np.array([-2,3,-5.9,6])
b9 = np.array([-6,8,-5.9,6])
b10 = np.array([-1,2,-6.9,7])
b11 = np.array([-1,3,-7.9,8])
b12 = np.array([-2,4,-8.9,9])
b13 = np.array([-6,9,-8.9,9])
#vertical
b14 = np.array([-0.9,1,-0,4])
b15 = np.array([-0.9,1,-5,7])
b16 = np.array([-0.9,1,-8,10])
b17 = np.array([-1.9,2,-1,3])
b18 = np.array([-1.9,2,-6,7])
b19 = np.array([-2.9,3,-2,3])
b20 = np.array([-2.9,3,-6,8])
b21 = np.array([-3.9,4,-0,1])
b22 = np.array([-3.9,4,-2,5])
b23 = np.array([-3.9,4,-6,9])
b24 = np.array([-4.9,5,-0,9])
b25 = np.array([-5.9,6,-2,10])
b26 = np.array([-6.9,7,-0,2])
b27 = np.array([-6.9,7,-4,8])
b28 = np.array([-7.9,8,-3,5])
b29 = np.array([-7.9,8,-7,9])
b30 = np.array([-8.9,9,-1,5])
b31 = np.array([-8.9,9,-6,8])
...
b32 = np.array([0,10,0,0.1])
b33 = np.array([0,0.1,0,10])
# b16 = np.array([0,0.1,-4,5])
b34 = np.array([0,10,-9.9,10])
b35 = np.array([-9.9,10,0,9])
...
O = [O1,O2,O3,O4,O5,O6,O7,O8,O9,O10,O11,O12,O13,O14,O15,O16,O17,O18,O19,O20,O21,O22,O23,O24,O25,O26,O27,O28,O29,O30,O31,O32,O33,O34,O35] # Border sets: O19,O20,O21,O22]
...
if __name__=="__main__":
    ...
    modelPath = currFile.replace('/demo/envs/testing.py', '')
